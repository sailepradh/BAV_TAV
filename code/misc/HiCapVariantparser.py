...
/Volumes/Work_drive/prj/BAV_TAV/data/raw_internal/Interaction_march_corrected/BAVTAV.Proximities.Probe_Distal_SP4_p01_either_sample_dist_width.txt
        ...
        for line in f:
            ...
            for rec in Vcfin.fetch (chr[0], int(chr[1]), int(chr[2])):
                ...
                if count == 6:
                    ...
                    #print ("\t".join(all_fields),"\t".join(chr),allele,changed_freq,rec.id, count_int_allele,unzip_array)
