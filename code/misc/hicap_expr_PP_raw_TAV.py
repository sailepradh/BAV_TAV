...
def int_dict_SP(int_files,expr_genes):
    ...
    for lines in int_files:
        ...
        counts_rep3 = int(fields[18])+ int(counts_rep)
...
def SP_CPM(results_interaction, supp_count_rep1,supp_counts_rep2,supp_counts_rep3):
    ...
    for k in results_interaction.keys():
        ...
        Enh_rep10 = round(Enh_rep1/(159286729 / 1000000),3)
        Enh_rep11 = round(Enh_rep2/(157794775 / 1000000),3)
        Enh_rep12 = round(Enh_rep2/(155605101 / 1000000),3)
